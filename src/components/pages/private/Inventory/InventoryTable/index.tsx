    ...
    <Card padding='none'>
      ...
      <div className='p-4 border-t border-primary-500/5 flex items-center justify-between'>
        ...
        <div className='flex items-center gap-2'>
          ...
          <button
            type='button'
            className='w-8 h-8 rounded-lg bg-primary-500 text-white text-xs font-bold'
          >
            1
          </button>
          ...
          <button
            type='button'
            className='w-8 h-8 rounded-lg hover:bg-primary-500/10 text-neutral-600/60 text-xs font-bold'
          >
            2
          </button>
