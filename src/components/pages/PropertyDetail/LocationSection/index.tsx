    ...
    return (
        <section className="space-y-6">
            <div className="flex justify-between items-end">
                <h3 className="text-2xl font-bold text-earth dark:text-white flex items-center gap-3">
            ...
            <div className="w-full h-[400px] rounded-[2.5rem] bg-cream dark:bg-slate-800 overflow-hidden relative border border-primary/10">
                <img
                    alt="Map visualization"
                    className="w-full h-full object-cover grayscale opacity-50 dark:opacity-20"
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl shadow-2xl border border-primary/20 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-earth/60 dark:text-slate-400">{markerDescription}</p>
                        </div>
                    </div>
                </div>
            </div>
