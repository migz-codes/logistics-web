...
const defaultProperties: Property[] = [
    {
        ...
        image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDTcKR8hM-rllk9n4fDVAv1yZ0s2dCnqZmdgZvVqDvhARcCMehqe5vH6Y2_43yo92RdWGBXCGsMZkmqDHfXNIMtrkA5QZS6nwsXcn-bE7trWl7VuzuezBG-02nJWcoagBvUnfZ06_O__rUF5g2sckccAsGEv36SvQWeAO4KPtuvp1g-FOkNg6fc3O8PQ9QxEKKa0AThg1rtnTHzSlCGuJ0IQgihrGluBrtYUebb7N3tOufK1fzr6XUjDyNmSIl5--x1LCNjD9nEF18',
    ...
    },
    {
        ...
        image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBuYEXj-i7PhFEfcbTeHMM3JMmYpiLkoWs898M2vjfQ-FbDZlaxdiGM36O7FHKUvyGd7dgn9vtDDmMyX5fR0aVy075mfAqWPyC1TjCq8j0vdz6obAme6bfCZ68HDSc3BgNYScHu3i9ReR5DwC1wQCJ9cXUJs3llPLUkDt97o8G2wY4yY3cvc296_paXHS5GwQicdWAF1WWgKEVXNe1nLzspwzbHOhVBBDE2H5nqyAKYjo-Lq7ZlOrc3tzJnvVQ27lHMQSLVOXpvDDM',
        ...
        <Card padding="none">
                    ...
                    <tbody>
                        {properties.map((property) => (
                            ...
                            >
                                ...
                                <td className="p-4 text-earth/60 dark:text-slate-400">
                                    {property.region}
                                </td>
                                <td className="p-4 text-earth/60 dark:text-slate-400">
                                    {property.category}
                                ...
                                <td className="p-4 text-center">
                                    <div className="flex items-center justify-center gap-2">
                                        ...
                                        <button className="p-2 rounded-lg hover:bg-red-500/10 text-earth/40 hover:text-red-500 transition-colors">
                                            <Icon name="delete" />
                                        </button>
                                    </div>
                                </td>
            ...
            <div className="p-4 border-t border-primary/5 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button className="w-8 h-8 rounded-lg hover:bg-primary/10 text-earth/60 text-xs font-bold">
                        2
                    </button>
                    <button className="w-8 h-8 rounded-lg hover:bg-primary/10 text-earth/60 text-xs font-bold">
                        3
