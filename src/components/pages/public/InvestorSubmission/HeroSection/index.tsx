  ...
  return (
    <header className='relative pt-32 pb-16 bg-gradient-to-br from-primary/5 via-transparent to-secondary/5'>
      <div className='max-w-7xl mx-auto px-6 text-center'>
        ...
        <h1 className='text-5xl md:text-7xl font-extrabold text-neutral-600 mb-6'>
          Submit Your <br />
          <span className='text-secondary-500 italic font-light'>Project</span>
        </h1>
        <p className='text-xl text-neutral-600/70 max-w-2xl mx-auto leading-relaxed'>
