  ...
  return (
    <header className='relative min-h-screen flex items-center overflow-hidden'>
      ...
      <div className='absolute inset-0 opacity-10'>
        ...
        <div className='absolute bottom-1/4 right-1/4 w-80 h-80 bg-secondary-500/30 rounded-full blur-3xl animate-pulse delay-1000' />
      </div>
      ...
      <div className='relative z-10 max-w-7xl mx-auto px-6 py-32 text-center'>
        ...
        <p className='text-xl md:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed mb-12'>
          We're pioneering the next generation of intelligent logistics infrastructure. Smart
          buildings, sustainable operations, and automated systems.
        </p>

        <div className='flex flex-wrap justify-center gap-8 text-white/60'>
          {[
            { id: 'smart-home', icon: 'smart_home', label: 'Smart Infrastructure' },
            { id: 'eco', icon: 'eco', label: 'Net Zero by 2030' },
            {
            ...
            <div key={item.id} className='flex items-center gap-3'>
              <Icon name={item.icon} className='text-secondary-500' size='lg' />
