...
const milestones: Milestone[] = [
    {
        ...
        description: 'IoT integration across all Class A warehouses for real-time monitoring of temperature, humidity, and occupancy.',
        icon: 'sensors',
        status: 'current'
    },
    {
        ...
        description: '100% renewable energy across our portfolio with rooftop solar installations and battery storage.',
        icon: 'solar_power',
        status: 'upcoming'
    },
    {
        ...
        description: 'Self-driving forklifts and automated sorting systems in partnership with leading robotics companies.',
    ...
    },
    {
        ...
        description: 'Complete virtual replicas of all facilities for predictive maintenance and optimization.',
        icon: 'view_in_ar',
        status: 'upcoming'
    },
    {
                        ...
                        {milestones.map((milestone, index) => (
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    <div className={`w-16 h-16 rounded-2xl flex items-center justify-center ${statusStyles[milestone.status]}`}>
                                ...
                                <div className="flex-1 md:w-5/12">
                                    <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-xl border border-primary/5 hover:border-primary/20 transition-all hover:-translate-y-1">
                                        <span className="text-sm font-bold text-secondary md:hidden">{milestone.year}</span>
