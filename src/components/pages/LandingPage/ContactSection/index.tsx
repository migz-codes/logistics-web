                ...
                <div className="grid lg:grid-cols-2 gap-16 items-start">
                    ...
                    <Card variant="elevated">
                        ...
                        <form className="space-y-6">
                            ...
                            <Textarea label="Message" placeholder="Tell us about your dream property..." rows={4} />
                    ...
                    <div className="space-y-8">
                        <div>
                            <h3 className="text-3xl font-bold text-earth mb-4">
                                We're Here to Help
                            </h3>
                            <p className="text-earth/60 leading-relaxed">
                                Have questions about buying, selling, or renting? Our team of experts is ready to assist you every step of the way.
                            </p>
                        </div>

                        <div className="space-y-6">
                            {[
                                { icon: 'location_on', label: 'Office', value: '123 Real Estate Blvd, Suite 500', sublabel: 'Miami, FL 33101' },
                                { icon: 'phone', label: 'Phone', value: '+1 (555) 123-4567', sublabel: 'Mon-Fri 9AM-6PM' },
                                { icon: 'mail', label: 'Email', value: 'hello@realestate.com', sublabel: 'We reply within 24hrs' }
                            ].map((item, index) => (
