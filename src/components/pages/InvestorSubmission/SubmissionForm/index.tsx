            ...
            <div className="flex items-center justify-between mb-10">
                {steps.map((step, index) => (
                    <div key={step.id} className="flex items-center">
                        <div
                            className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm ${currentStep >= step.id
                        ...
                        <span className={`ml-3 text-sm font-bold ${currentStep >= step.id ? 'text-earth dark:text-white' : 'text-earth/40'
                            }`}>
                            {step.label}
                        </span>
                        {index < steps.length - 1 && (
                            <div className="w-24 h-1 bg-cream dark:bg-slate-800 mx-6">
                                <div
                                    className={`h-full bg-primary transition-all ${currentStep > step.id ? 'w-full' : 'w-0'
                                        }`}
                                />
                            </div>
                        )}
